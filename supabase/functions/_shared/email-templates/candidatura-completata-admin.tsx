...
export const CandidaturaCompletataAdminEmail = ({
  ...
  return (
    <Html lang="it" dir="ltr">
      <Head />
      <Preview>{`Candidatura completata — ${nome} ${cognome}`}</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={h1}>Candidatura completata</Heading>
          <Text style={text}>La candidatura è ora completa e pronta per la decisione.</Text>
          ...
          <Text style={row}><strong>Data di completamento:</strong> {fmt(dataInvioIso)}</Text>
...
export default CandidaturaCompletataAdminEmail
